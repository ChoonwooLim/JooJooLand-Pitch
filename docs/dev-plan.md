...
| 사업인허가(Permits) — 사전심사 분석 추적 대시보드 + PDF 뷰어 | 완료 | Steven | 2026-05-30 |
| 지도 — 위경도 직접입력 셀 + 해외 도시명 지오코딩 (이동검색) | 완료 | Steven | 2026-05-30 |
| 배포 — 풀스택 단일 이미지 자동배포 (프런트-only 푸시 자동 반영) | 완료 | Steven | 2026-05-30 |
